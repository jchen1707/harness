...
| Goal           | Stop condition                                                                                                                                                                               |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs`         | Every claim in `CLAUDE.md`, `README.md`, `docs/architecture.md` and every path-scoped `CLAUDE.md` matches the code; every documented command runs; no reference to a deleted file or command |
...
| `deps`         | Every declared dependency is used; nothing used is undeclared; the approved-stack list in `CLAUDE.md` matches what is installed                                                              |
