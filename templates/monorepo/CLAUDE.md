...
| ---------------------- | -------------------------------------------------- | ------------------------------ |
| `apps/api/`            | the HTTP API — Python, `uv`, FastAPI               | `apps/api/CLAUDE.md`           |
| `apps/web/`            | the web client — Vite, React, TypeScript           | `apps/web/CLAUDE.md`           |
...
that app's own `CLAUDE.md`, next to the code it describes, where an agent working in
