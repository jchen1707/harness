...
| ------------ | --------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `monorepo/`  | the repository root         | the router `CLAUDE.md`, the root config, `docs/`, the contract package                                        |
...
| `split-api/` | an api repository           | `--split` only: the standalone `CLAUDE.md`, its config, and the workflow that publishes the contract on a tag |
| `split-web/` | a web repository            | `--split` only: the standalone `CLAUDE.md`, its config, and `contract.json` — the pinned version              |
