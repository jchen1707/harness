...
| **B — stack-specific** | Gates, hook config, `docs/architecture.md`, path-scoped `CLAUDE.md`, each frame's checklist | `python-harness` / `frontend-harness`. Diverges on purpose. |
